...
import AttendeeSnapshot from './pages/admin/AttendeeSnapshot';
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/attendee-snapshot/:event_id" element={<ProtectedRoute role="admin"><AttendeeSnapshot /></ProtectedRoute>} />
          ...
          <Route path="/admin/exhibitors" element={<ProtectedRoute role="admin"><AdminExhibitors /></ProtectedRoute>} />
        <Route path="/admin/qrcode" element={<ProtectedRoute role="admin"><AdminQRCode /></ProtectedRoute>} />
