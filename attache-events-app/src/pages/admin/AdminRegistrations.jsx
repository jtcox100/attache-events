                ...
                {filtered.map((a, i) => (
                  <tr key={a.id} style={{ backgroundColor: i % 2 === 0 ? '#fff' : '#f9fafb', borderBottom: '1px solid #f0f0f0' }}>
                    {editingId === a.id ? (
                      ...
                      <>
                        <td className="px-4 py-3 font-medium break-words" style={{ color: '#262D33' }}>
                          {a.name}
                        ...
                        <td className="px-4 py-3 text-gray-500 break-all">{a.email}</td>
                        <td className="px-4 py-3 text-gray-500 break-words">{a.company || '—'}</td>
                        <td className="px-4 py-3 text-gray-500 break-words">{a.title || '—'}</td>
