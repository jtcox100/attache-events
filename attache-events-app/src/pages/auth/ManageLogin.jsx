...
const ROLES = [
  ...
  { label: 'Vendor', value: 'vendor', endpoint: '/api/auth/vendor/login', fields: ['event_select', 'email', 'password'] },
];
...
export default function ManageLogin() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const payload = { ...form };
    if (selectedRole.value === 'vendor' && form.event_select) { payload.event_id = form.event_select; }
